...
def insert():
    with SqlReader(SQL, CODE) as arquivo:
        arquivo.addInfo("Clientes", Nome="Gabriel",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="16538424282",
                        Endereço="Zona Rural")
        arquivo.addInfo("Clientes", Nome="Andre",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="16538429542",
                        Endereço="Zona Rural")
        arquivo.addInfo("Clientes", Nome="João",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="12738649182",
                        Endereço="Zona Rural")
        arquivo.addInfo("Clientes", Nome="José",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="12738422182",
                        Endereço="Zona Rural")
        arquivo.addInfo("Clientes", Nome="Einstein",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="12738429982",
                        Endereço="Zona Rural")
        arquivo.addInfo("Clientes", Nome="Tesla",
                        DataNasc="05-02-2003", Email="gsam@gmail.com",
                        Telefone="(35) 98831-7283", Cpf="12738429452",
                        Endereço="Zona Rural")
...
if __name__ == "__main__":
    insert()
    with SqlReader(SQL, CODE) as arquivo:
        print(arquivo.getCabec("Clientes"))
